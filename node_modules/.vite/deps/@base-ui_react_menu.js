import {
  ...
  useTypeahead,
  useValueAsRef
} from "./chunk-IAW673BN.js";
import "./chunk-3SNXPYSM.js";
import {
  useTimeout
} from "./chunk-4UKOOLHH.js";
import {
  CompositeList,
  DirectionContext,
  getCssDimensions,
...
} from "./chunk-GC3BJVVW.js";
import {
  getParentNode,
  getWindow,
  isHTMLElement,
  isLastTraversableNode
} from "./chunk-W6MI3N3A.js";
import {
  useIsoLayoutEffect,
  useStableCallback
} from "./chunk-TLUY3HD2.js";
import {
...
var ToolbarRootContext = React16.createContext(void 0);
if (true) ToolbarRootContext.displayName = "ToolbarRootContext";
function useToolbarRootContext(optional) {
  const context = React16.useContext(ToolbarRootContext);
  if (context === void 0 && !optional) {
...
var MenuPopup = React17.forwardRef(function MenuPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    finalFocus,
  ...
  const setPopupElement = React17.useCallback((element2) => {
...
var MenuPortalContext = React18.createContext(void 0);
if (true) MenuPortalContext.displayName = "MenuPortalContext";
function useMenuPortalContext() {
  const value = React18.useContext(MenuPortalContext);
  if (value === void 0) {
...
var MenuPortal = React19.forwardRef(function MenuPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React20.useState(null);
  ...
  const arrowRef = React20.useRef(null);
  ...
  const autoUpdateOptions = React20.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React20.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
  ...
  const arrowStyles = React20.useMemo(() => {
    var _a2, _b2;
    return {
      position: "absolute",
...
var MenuPositioner = React21.forwardRef(function MenuPositioner2(componentProps, forwardedRef) {
  var _a;
  const {
    anchor: anchorProp,
  ...
  const previousTriggerRef = React21.useRef(null);
  ...
  const positionerProps = React21.useMemo(() => {
    const hiddenStyles = {};
    if (!open) {
...
var MenuRadioGroupContext = React22.createContext(void 0);
if (true) MenuRadioGroupContext.displayName = "MenuRadioGroupContext";
function useMenuRadioGroupContext() {
  const context = React22.useContext(MenuRadioGroupContext);
  if (context === void 0) {
...
var MenuRadioGroup = React23.memo(React23.forwardRef(function MenuRadioGroup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    value: valueProp,
...
var MenuRadioItemContext = React24.createContext(void 0);
if (true) MenuRadioItemContext.displayName = "MenuRadioItemContext";
function useMenuRadioItemContext() {
  const context = React24.useContext(MenuRadioItemContext);
  if (context === void 0) {
...
var MenuRadioItem = React25.forwardRef(function MenuRadioItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var MenuRadioItemIndicator = React26.forwardRef(function MenuRadioItemIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    keepMounted = false,
...
var MenubarContext = React27.createContext(null);
if (true) MenubarContext.displayName = "MenubarContext";
function useMenubarContext(optional) {
  const context = React27.useContext(MenubarContext);
...
var MenuStore = class _MenuStore extends ReactStore {
  constructor(initialState) {
    super({
      ...
      positionerRef: React28.createRef(),
      popupRef: React28.createRef(),
      typingRef: {
        current: false
      },
      itemDomElements: {
      ...
      triggerFocusTargetRef: React28.createRef(),
      beforeContentFocusGuardRef: React28.createRef(),
...
var MenuSubmenuRootContext = React29.createContext(void 0);
if (true) MenuSubmenuRootContext.displayName = "MenuSubmenuRootContext";
function useMenuSubmenuRootContext() {
  return React29.useContext(MenuSubmenuRootContext);
}
...
var MenuRoot = fastComponent(function MenuRoot2(props) {
  ...
  const parentFromContext = React30.useMemo(() => {
  ...
  const floatingParentNodeId = store.useState("floatingParentNodeId");
  const openEventRef = React30.useRef(null);
  ...
  const allowOutsidePressDismissalRef = React30.useRef(parent.type !== "context-menu");
  ...
  const allowTouchToCloseRef = React30.useRef(true);
  ...
  const createMenuEventDetails = React30.useCallback((reason) => {
  ...
  const handleImperativeClose = React30.useCallback(() => {
  ...
  React30.useImperativeHandle(ctx == null ? void 0 : ctx.positionerRef, () => positionerElement, [positionerElement]);
  React30.useImperativeHandle(ctx == null ? void 0 : ctx.actionsRef, () => ({
    setOpen
  }), [setOpen]);
  ...
  const direction = useDirection();
  const setActiveIndex = React30.useCallback((index) => {
  ...
  const onTypingChange = React30.useCallback((nextTyping) => {
  ...
  const activeTriggerProps = React30.useMemo(() => {
  ...
  const inactiveTriggerProps = React30.useMemo(() => {
  ...
  const popupProps = React30.useMemo(() => getFloatingProps({
    onMouseMove() {
      store.set("allowMouseEnter", true);
      if (parent.type === "menu") {
        store.set("hoverEnabled", false);
  ...
  const itemProps = React30.useMemo(() => getItemProps(), [getItemProps]);
  store.useSyncedValues({
    floatingRootContext,
    activeTriggerProps,
...
function usePopupAutoResize(parameters) {
  ...
  const liveDimensionsRef = React35.useRef(null);
...
var DirectionProvider = function DirectionProvider2(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(DirectionContext.Provider, {
    value: contextValue,
...
function usePopupViewport(parameters) {
  ...
  if (!isTransitioning) {
    childrenToRender = (0, import_jsx_runtime12.jsx)("div", {
      "data-current": true,
      ref: currentContainerRef,
      children
    }, currentContentKey);
  } else {
    childrenToRender = (0, import_jsx_runtime12.jsxs)(React37.Fragment, {
      ...
      }, "previous"), (0, import_jsx_runtime12.jsx)("div", {
        "data-current": true,
        ref: currentContainerRef,
...
var MenuViewport = React38.forwardRef(function MenuViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    children,
...
var Separator = React39.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
